...
//  COMPLETED (15) Override onCreate and create the weather table from within it
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_WEATHER_TABLE = "CREATE TABLE " +                   //SOLUTION IMPORTED WeatherContract
                WeatherContract.WeatherEntry.TABLE_NAME + " (" +
                WeatherContract.WeatherEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                WeatherContract.WeatherEntry.COLUMN_DATE + " INTEGER, " +
                WeatherContract.WeatherEntry.COLUMN_WEATHER_ID + " INTEGER, " +     //SOLUTION HAD ALL EXCEPT ID/DATE AS REAL
